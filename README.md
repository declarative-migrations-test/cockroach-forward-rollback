# cockroach-forward-rollback
    ...
    **Live infrastructure:** CockroachDB
    ...
    1. Verify repeated apply and rollback under CockroachDB transaction and DDL semantics across the supported happy-path states and canonical fixtures.
2. Verify repeated apply and rollback under CockroachDB transaction and DDL semantics under retries, interruption, concurrency, offline operation, or partial failure.
3. Verify repeated apply and rollback under CockroachDB transaction and DDL semantics preserves authorization, idempotency, integrity, observability, and actionable failure classification.
